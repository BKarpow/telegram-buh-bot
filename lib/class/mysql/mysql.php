...
require __DIR__ . '/ConfigMySql.php';
require __DIR__ . '/DBException.php';
...
final class MySql extends ConfigMySql
{
	...
	*/
	...
	{
		$db = new mysqli($this->host, $this->user, $this->password, $this->base);
		if ($db->connect_errno){
